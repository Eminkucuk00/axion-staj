...
with open(md_file, 'w', encoding='utf-8') as f:
    f.write("# Makine Öğrenmesi & CLV Dev Ansiklopedisi: Uzun ve Tam Kapsamlı Rehber\n\n")
...
print("Devasa boyutlu ansiklopedik markdown yazıldı.")
...
<body>
    <div class="cover-page">
        ...
        <div class="cover-content">
            ...
            <div class="cover-subtitle">TAM KAPSAMLI DEV REHBER: Her Detayıyla Modeller, Bakkal Analojileri ve Sistematik İspatlar</div>
            <div class="cover-author">GENİŞLETİLMİŞ VE DERİNLEŞTİRİLMİŞ EDİSYON</div>
        </div>
    </div>
    <div class="content">
        {content}
...
<div style="font-size: 11px; color: #64748b; font-family: 'Open Sans', sans-serif; text-align: center; width: 100%; border-top: 1px solid #e2e8f0; padding-top: 8px; margin: 0 25mm;">
    Makine Öğrenmesi Dev Ansiklopedisi | Sayfa <span class="pageNumber"></span> / <span class="totalPages"></span>
</div>
"""
...
print("Massive Ansiklopedik ML PDF created successfully!")
